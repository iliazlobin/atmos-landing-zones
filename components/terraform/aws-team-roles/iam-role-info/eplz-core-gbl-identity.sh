...
role_arns=(
    ["admin"]="arn:aws:iam::222222222222:role/eplz-core-gbl-identity-admin"
    ["devops"]="arn:aws:iam::222222222222:role/eplz-core-gbl-identity-devops"
    ["viewer"]="arn:aws:iam::222222222222:role/eplz-core-gbl-identity-viewer"
  )
