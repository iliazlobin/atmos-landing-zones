...
profiles=(
    ["admin"]="eplz-core-gbl-network-admin"
    ["terraform"]="eplz-core-gbl-network-terraform"
  )

declare -A role_arns

role_arns=(
    ["admin"]="arn:aws:iam::327181051710:role/eplz-core-gbl-network-admin"
    ["terraform"]="arn:aws:iam::327181051710:role/eplz-core-gbl-network-terraform"
  )
