...
profiles=(
    ["admin"]="eplz-core-gbl-dns-admin"
    ["terraform"]="eplz-core-gbl-dns-terraform"
  )

declare -A role_arns

role_arns=(
    ["admin"]="arn:aws:iam::872958331007:role/eplz-core-gbl-dns-admin"
    ["terraform"]="arn:aws:iam::872958331007:role/eplz-core-gbl-dns-terraform"
  )
