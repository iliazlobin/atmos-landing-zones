...
profiles=(
    ["admin"]="eplz-core-gbl-audit-admin"
    ["terraform"]="eplz-core-gbl-audit-terraform"
  )

declare -A role_arns

role_arns=(
    ["admin"]="arn:aws:iam::721232552714:role/eplz-core-gbl-audit-admin"
    ["terraform"]="arn:aws:iam::721232552714:role/eplz-core-gbl-audit-terraform"
  )
