...
role_arns=(
    ["admin"]="arn:aws:iam::333333333333:role/eplz-epme3s-gbl-prod-admin"
    ["devops"]="arn:aws:iam::333333333333:role/eplz-epme3s-gbl-prod-devops"
    ["terraform"]="arn:aws:iam::333333333333:role/eplz-epme3s-gbl-prod-terraform"
  )
